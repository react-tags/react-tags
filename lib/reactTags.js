...
var ReactTags = React.createClass({
    ...
    handlePaste: function (e) {
      e.preventDefault()
      let string = e.clipboardData.getData('Text')
      let commas = string.split(',')
      let spaces = string.split(' ')

      if (commas.length > spaces.length)
        commas.forEach((buzzword) => this.props.handleAddition(buzzword))
      else
        spaces.forEach((buzzword) => this.props.handleAddition(buzzword))
    },
    addTag: function(tag) {
