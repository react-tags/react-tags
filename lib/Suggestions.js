...
class Suggestions extends Component {
  ...
  componentDidUpdate = prevProps => {
    ...
    if (suggestionsContainer && prevProps.selectedIndex !== this.props.selectedIndex) {
      const activeSuggestion = suggestionsContainer.querySelector(`.${this.props.classNames.activeSuggestion}`)
    ...
    const suggestions = props.suggestions.map(function (item, i) {
      return (
          <li key={i}
              ...
              className={i == props.selectedIndex ? this.props.classNames.activeSuggestion : ""}>
