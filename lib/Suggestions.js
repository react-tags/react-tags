...
class Suggestions extends Component {
  ...
  renderSuggestion = (item, i) => {
    ...
    const suggestionLabel = (
      <span className={props.classNames.suggestionLabel} dangerouslySetInnerHTML={this.markIt(item, props.query)}/>
    );
    const content = props.suggestionRenderer ? props.suggestionRenderer(suggestionLabel) : suggestionLabel;
  ...
  render() {
    const { props } = this;
    const suggestions = props.suggestions.map((item, i) => this.renderSuggestion(item, i));
