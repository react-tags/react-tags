...
class ReactTags extends Component {
  ...
  removeInternalProps(props) {
    Object.keys(ReactTags.propTypes).forEach((key) => delete props[key]);
    return props;
  }
  ...
  render() {
    ...
    const propsToSpread = this.removeInternalProps(remainingProps);
    ...
    return (
      <div className={this.state.classNames.tags} {...propsToSpread}>
