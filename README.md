...
|[`allowEmpty`](#allowEmpty) | `Boolean` | `false` | Boolean value to control whether empty tags should be allowed
...
This prop controls whether empty tags should be allowed.
