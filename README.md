...
| enableFuzzySearch | `boolean` | `false` | Enables the fuzzy search on suggestions |
...
###  enableFuzzySearch
This prop enables fuzzy search on suggestions. Default fuzzy distance of 5 is considered.
This uses  [fuzzify](https://github.com/ad1992/fuzzify) library for  Levenshtein Distance algorithm.